...
flowchart TD
    ...
    Users1["Пользователи Вуза #1"]
    Users2["Пользователи Вуза #2"]
    UsersN["Пользователи Вуза #N"]
    ...
    classDef serverClass fill:#2a4365,stroke:#63b3ed,color:#e2e8f0
    classDef channelClass fill:#2c5282,stroke:#63b3ed,color:#e2e8f0
    classDef edgeClass fill:#2a4365,stroke:#63b3ed,color:#e2e8f0
    classDef usersClass fill:#2a4365,stroke:#63b3ed,color:#e2e8f0
    
    class Cloud serverClass
    class Channel channelClass
    class Edge1,Edge2,EdgeN edgeClass
    class Users1,Users2,UsersN usersClass
```
